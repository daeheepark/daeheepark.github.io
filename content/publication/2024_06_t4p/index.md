...
summary: This paper presents a novel trajectory prediction method using masked autoencoders and actor-specific token memory to improve accuracy and efficiency under distribution shifts.
